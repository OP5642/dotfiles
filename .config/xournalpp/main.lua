function initUi()
  ...
  app.registerUi({["menu"] = "Cycle through colors", ["callback"] = "color", ["accelerator"] = "<Alt>v"});
  app.registerUi({["menu"] = "Cycle through drawing type", ["callback"] = "drawingtype", ["accelerator"] = "<Alt>c"}); -- <Alt>d is already used for the menu "Datei" in German
